...
void lcd_init() {
    PORTB = 0x00;
    lcd_nibble(0x03); lcd_pulse(); _delay((unsigned long)((15)*(8000000/4000.0)));
    lcd_nibble(0x03); lcd_pulse(); _delay((unsigned long)((5)*(8000000/4000.0)));
            ...
            for (int col = 0; col < 4; col++) {
                if (!(PORTD & (1 << col))) {
                    ...
                    if (key == '=') {
                        ...
                        lcd_byte(0x01, 0); _delay((unsigned long)((2)*(8000000/4000.0)));
                        char result_str[10];
